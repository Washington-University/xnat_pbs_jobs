...
main()
{
	...
	working_directory_name="${BUILD_HOME}/${g_project}/IcaFixPackagingHCP.${g_subject}.${current_seconds_since_epoch}"
	...
	script_file_to_submit=${working_directory_name}/${g_subject}.IcaFixPackagingHCP.XNAT_PBS_job.sh
	...
	echo "/home/HCPpipeline/pipeline_tools/xnat_pbs_jobs/IcaFixProcessingHCP/IcaFixPackaging.sh \\" >> ${script_file_to_submit}
