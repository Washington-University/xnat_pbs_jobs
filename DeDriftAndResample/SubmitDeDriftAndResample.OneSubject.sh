...
main()
{
	...
	working_directory_name="${BUILD_HOME}/${g_project}/DeDriftAndResample_${current_seconds_since_epoch}_${g_subject}"
	...
	echo ""
	echo "/home/HCPpipeline/pipeline_tools/xnat_pbs_jobs/DeDriftAndResample/DeDriftAndResample.XNAT.sh \\" >> ${script_file_to_submit}
