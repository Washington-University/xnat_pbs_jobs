...
inform() 
{
	echo "CreateVolumePreprocPackage.sh: ${1}"
}
...
main()
{
	...
	for modality in REST MOVIE RET ; do
		...
		inform ""
		release_notes_file=${script_tmp_dir}/${g_subject}/release-notes/${g_subject}_7T_${modality}_Volume_preproc.txt
		...
		new_package_name="${g_subject}_7T_${modality}_Volume_preproc.zip"
