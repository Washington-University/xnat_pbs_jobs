...
SCRIPT_NAME="DeDriftAndResampleHCP7T_HighRes.XNAT.sh"
...
main()
{
	...
	local LowResMeshes="59" # Delimit with @ e.g. 32@59, multiple resolutions not currently supported for fMRI data
	...
	local ConcatRegName="1.6mm_MSMAll" # Final name of ${RegName}, the string that identifies files as being registered with this method
