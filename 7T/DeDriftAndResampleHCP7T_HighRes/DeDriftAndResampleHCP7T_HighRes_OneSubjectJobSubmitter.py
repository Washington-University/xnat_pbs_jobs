...
"""
DeDriftAndResampleHCP7T_HighRes_OneSubjectJobSubmitter.py: Submit DeDriftAndResampleHCP7T_HighRes processing 
...
class DeDriftAndResampleHCP7T_HighRes_OneSubjectJobSubmitter(one_subject_job_submitter.OneSubjectJobSubmitter):
    ...
    def PIPELINE_NAME(self):
        return 'DeDriftAndResampleHCP7T_HighRes'
    ...
    def submit_jobs(self):
        ...
        if self.validate_parameters():
            ...
            work_script.write(self.xnat_pbs_jobs_home + os.sep + '7T' + os.sep + 'DeDriftAndResampleHCP7T_HighRes' + os.sep + 'DeDriftAndResampleHCP7T_HighRes.XNAT.sh \\' + os.linesep)
