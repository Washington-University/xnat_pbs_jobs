...
main()
{
	...
	for modality in MOVIE REST RET ; do
		...
		for scan_dir in ${scan_dirs} ; do
			...
			file_list+=" MNINonLinear/Results/${fMRIName}/${fMRIName}_Atlas_1.6mm.dtseries.nii "
		...
		inform ""
		release_notes_file=${script_tmp_dir}/${g_subject}/release-notes/${g_subject}_7T_${modality}_1.6mm_preproc.txt
