...
subject_file_name="${SUBJECT_FILES_DIR}/CheckDeDriftAndResampleHCP7T.subjects"
...
for subject in ${subjects} ; do
	if [[ ${subject} != \#* ]]; then
		...
		./CheckDeDriftAndResampleHCP7TCompletion.sh --project=${project} --subject=${subject} #--details
