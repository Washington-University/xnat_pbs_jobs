...
"""SubmitDeDriftAndResampleHCP7TBatch.py: Submit a batch of DeDriftAndResample processing jobs for the HCP 7T project."""
...
class DeDriftAndResampleHcp7TBatchSubmitter(batch_submitter.BatchSubmitter):
    """This class submits batches of DeDriftAndResample processing jobs for the HCP 7T project."""

    def __init__(self):
        """Construct a DeDriftAndResampleHcp7TBatchSubmitter"""
