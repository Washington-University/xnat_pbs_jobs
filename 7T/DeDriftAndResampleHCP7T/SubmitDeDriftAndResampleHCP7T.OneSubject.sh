...
SCRIPT_NAME="SubmitDeDriftAndResampleHCP7T.OneSubject.sh"
...
main()
{
	...
	output_resource=${MSM_ALL_DEDRIFT_RESOURCE_NAME}
	...
	echo "${XNAT_PBS_JOBS_HOME}/7T/DeDriftAndResampleHCP7T/DeDriftAndResampleHCP7T.XNAT.sh \\" >> ${script_file_to_submit}
