        ...
        for subject_id in subject_ids:
            ...
            if ((dir95_scan_LR_scan_name in available_diffusion_scan_names) and 
                ...
                if ((dir96_scan_LR_scan_name in available_diffusion_scan_names) and
                    (dir96_scan_RL_scan_name not in available_diffusion_scan_names)):
                
                    _inform("Subject: " + str(subject_info) + " has all dir95 and dir97 scans and only dir96_LR.")

                elif ((dir96_scan_LR_scan_name not in available_diffusion_scan_names) and
                      (dir96_scan_RL_scan_name in available_diffusion_scan_names)):

                    _inform("Subject: " + str(subject_info) + " has all dir95 and dir97 scans and only dir96_RL.")
