...
project="HCP_500"
subject_file_name="${SUBJECT_FILES_DIR}/${project}.DiffusionPreprocessingHCP.NewEddyTesting.Batch.subjects"
...
for subject in ${subjects} ; do
	...
	if [[ ${subject} != \#* ]]; then
		...
		/home/HCPpipeline/pipeline_tools/xnat_pbs_jobs/DiffusionPreprocessingHCP/SubmitDiffusionPreprocessingHCP.NewEddyTesting.OneSubject.sh \
			--user=${userid} \
			--password=${password} \
			--put-server=${server} \
			--project=${project} \
