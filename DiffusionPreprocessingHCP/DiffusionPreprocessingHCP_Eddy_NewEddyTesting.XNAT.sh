...
#~ND~START~
#
# # DiffusionPreprocessingHCP_Eddy_NewEddyTesting.XNAT.sh
#
# ## Copyright Notice
#
...
main()
{
	...
	setup_file="${SCRIPTS_HOME}/SetUpHCPPipeline_DiffusionPreprocHCP_NewEddyTesting.sh"
	...
	# NEW CODE TEMPORARILY ADDED UNTIL POST_EDDY PHASE IS USED
