...
{
	local msg=${1}
	echo "SubmitDiffusionPreprocessingHCP.NewEddyTesting.OneSubject.sh: ${msg}"
}
...
main()
{
	...
	working_directory_name="${BUILD_HOME}/${g_project}/DiffusionPreprocessingHCP.NewEddyTesting.${g_subject}.${current_seconds_since_epoch}"
	...
	echo "/home/HCPpipeline/pipeline_tools/xnat_pbs_jobs/DiffusionPreprocessingHCP/DiffusionPreprocessingHCP_PreEddy_NewEddyTesting.XNAT.sh \\" >> ${pre_eddy_script_file_to_submit}
	...
	echo "/home/HCPpipeline/pipeline_tools/xnat_pbs_jobs/DiffusionPreprocessingHCP/DiffusionPreprocessingHCP_Eddy_NewEddyTesting.XNAT.sh \\" >> ${eddy_script_file_to_submit}
	...
	# echo "  --resource-suffix=\"Diffusion_preproc_repol\" " >> ${put_script_file_to_submit}
