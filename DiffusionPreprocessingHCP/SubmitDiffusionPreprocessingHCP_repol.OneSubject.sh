...
main()
{
	...
	echo "/home/HCPpipeline/pipeline_tools/xnat_pbs_jobs/DiffusionPreprocessingHCP/DiffusionPreprocessingHCP_PreEddy_repol.XNAT.sh \\" >> ${pre_eddy_script_file_to_submit}
	...
	echo "/home/HCPpipeline/pipeline_tools/xnat_pbs_jobs/DiffusionPreprocessingHCP/DiffusionPreprocessingHCP_Eddy_repol.XNAT.sh \\" >> ${eddy_script_file_to_submit}
