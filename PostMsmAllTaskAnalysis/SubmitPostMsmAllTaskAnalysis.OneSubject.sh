...
main()
{
	...
	for task in ${task_scan_names} ; do
		...
		put_script_file_to_submit=${working_directory_name}/${g_subject}.${task}.PostMsmAllTaskAnalysis.${g_project}.${g_session}.${current_seconds_since_epoch}.XNAT_PBS_PUT_job.sh
