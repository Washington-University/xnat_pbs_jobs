...
project="HCP_Staging"
subject_file_name="${SUBJECT_FILES_DIR}/${project}.FunctionalPackagingHCP.subjects"
...
for subject in ${subjects} ; do
	...
	if [[ ${subject} != \#* ]]; then
		...
		${XNAT_PBS_JOBS}/FunctionalPreprocessingHCP/SubmitFunctionalPackagingHCP.OneSubject.sh \
			--user=${userid} \
			--password=${password} \
			--server=${server} \
			--project=${project} \
