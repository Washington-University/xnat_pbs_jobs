...
main()
{
	...
	start_time_file="${g_working_dir}/TaskAnalysis.starttime"
	...
	# ----------------------------------------------------------------------------------------------
	increment_step
	update_xnat_workflow ${g_current_step} "Run TaskfMRIAnalysis.sh script with smoothing 2 and VBA=NO" ${g_step_percent}
	...
	# ----------------------------------------------------------------------------------------------
	# Step - Run TaskfMRIAnalysis.sh script with smoothing 4 and VBA=YES
	# ----------------------------------------------------------------------------------------------
	increment_step
	...
	# ----------------------------------------------------------------------------------------------
	# Step - Run TaskfMRIAnalysis.sh script with smoothing 8 and VBA=NO
	# ----------------------------------------------------------------------------------------------
	increment_step
	...
	script_cmd+="--origsmoothingFWHM=2 "
	script_cmd+="--confound=NONE "
	script_cmd+="--finalsmoothingFWHM=8 "
	script_cmd+="--temporalfilter=200 "
	script_cmd+="--vba=NO "
	...
	# ----------------------------------------------------------------------------------------------
	# Step - Run TaskfMRIAnalysis.sh script with smoothing 12 and VBA=NO
	# ----------------------------------------------------------------------------------------------
	increment_step
	...
	script_cmd+="--origsmoothingFWHM=2 "
	script_cmd+="--confound=NONE "
	script_cmd+="--finalsmoothingFWHM=12 "
	script_cmd+="--temporalfilter=200 "
	script_cmd+="--vba=NO "
