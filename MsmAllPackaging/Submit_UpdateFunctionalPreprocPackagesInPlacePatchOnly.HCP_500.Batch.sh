...
for subject in ${subjects} ; do
    ...
    if [[ ${subject} != \#* ]]; then
		...
		echo ""
		echo "/home/HCPpipeline/pipeline_tools/xnat_pbs_jobs/MsmAllPackaging/UpdateFunctionalPreprocPackagesInPlace.sh \\" >> ${script_file_to_submit}
		...
		echo "  --patch-only" >> ${script_file_to_submit}
