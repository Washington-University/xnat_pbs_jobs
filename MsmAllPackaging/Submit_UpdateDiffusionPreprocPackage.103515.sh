...
project="HCP_500"
packages_root="/HCP/hcpdb/packages/prerelease/zip/HCP_500"
...
#subject_file_name="${SUBJECT_FILES_DIR}/${project}.UpdateDiffusionPackage.subjects"
...
for subject in ${subjects} ; do
    ...
    if [[ ${subject} != \#* ]]; then
		...
		script_file_to_submit=${scripts_to_submit_dir}/${subject}.UpdateDiffusionPackage.${current_time_str}.PBS_job.sh
		...
		echo ""
		echo "/home/HCPpipeline/pipeline_tools/xnat_pbs_jobs/MsmAllPackaging/UpdateDiffusionPreprocPackage.sh \\" >> ${script_file_to_submit}
		...
		echo ""
		echo "--------------------------------------------------------------------------------"
		echo " Submitting UpdateDiffusionPreprocPackage job for subject: ${subject}"
