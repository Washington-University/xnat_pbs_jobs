...
for subject in ${subjects} ; do
    ...
    if [[ ${subject} != \#* ]]; then
		...
		echo ""
		echo "/home/HCPpipeline/pipeline_tools/xnat_pbs_jobs/MsmAllPackaging/UpdateDiffusionPreprocPackage/UpdateDiffusionPreprocPackage.sh \\" >> ${script_file_to_submit}
