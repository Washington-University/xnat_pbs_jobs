...
for subject in ${subjects} ; do
    ...
    if [[ ${subject} != \#* ]]; then
		...
		echo "  --release-notes-template-file=/home/HCPpipeline/pipeline_tools/xnat_pbs_jobs/MsmAllPackaging/UpdateStructuralPreprocPackage/StructuralPrepcPackageReleaseNotes.txt \\" >> ${script_file_to_submit}
