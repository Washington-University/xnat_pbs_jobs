...
subject_file_name="${project}.UpdateStructuralPreprocPackage.subjects"
...
for subject in ${subjects} ; do
    ...
    if [[ ${subject} != \#* ]]; then
		...
		echo ""
		echo "/home/HCPpipeline/pipeline_tools/xnat_pbs_jobs/MsmAllPackaging/UpdateStructuralPreprocPackage/UpdateStructuralPreprocPackage.sh \\" >> ${script_file_to_submit}
