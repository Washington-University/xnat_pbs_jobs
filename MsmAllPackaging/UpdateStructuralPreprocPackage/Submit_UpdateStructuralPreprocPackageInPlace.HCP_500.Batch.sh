...
subject_file_name="${SUBJECT_FILES_DIR}/${project}.UpdateStructuralPreprocPackageInPlace.subjects"
...
for subject in ${subjects} ; do
    ...
    if [[ ${subject} != \#* ]]; then
		...
		script_file_to_submit=${scripts_to_submit_dir}/${subject}.UpdateStructuralPreprocPackageInPlace.${current_time_str}.PBS_job.sh
		...
		echo ""
		echo "/home/HCPpipeline/pipeline_tools/xnat_pbs_jobs/MsmAllPackaging/UpdateStructuralPreprocPackage/UpdateStructuralPreprocPackageInPlace.sh \\" >> ${script_file_to_submit}
		...
		echo "  --release-notes-template-file=/home/HCPpipeline/pipeline_tools/xnat_pbs_jobs/MsmAllPackaging/UpdateStructuralPreprocPackage/StructuralPreprocPackageReleaseNotes.txt \\" >> ${script_file_to_submit}
