...
archive_root="/HCP/hcpdb/archive/HCP_900/arc001"
...
for subject in ${subjects} ; do
    ...
    if [[ ${subject} != \#* ]]; then
		...
		script_file_to_submit=${scripts_to_submit_dir}/${subject}.UpdateFixPackageInPlace.${current_time_str}.PBS_job.sh
		...
		echo ""
		echo "/home/HCPpipeline/pipeline_tools/xnat_pbs_jobs/MsmAllPackaging/UpdateFixPackage/UpdateFixPackageInPlace.sh \\" >> ${script_file_to_submit}
