...
main()
{
	...
	for scan in ${g_scan} ; do
		...
		working_directory_name="${BUILD_HOME}/${g_project}/RestingStateStats.${g_subject}.${scan}.${current_seconds_since_epoch}"
		...
		jsession=`curl -k -u ${g_user}:${g_password} https://${XNAT_PBS_JOBS_XNAT_SERVER}/data/JSESSION`
		...
		standard_out_file=${working_directory_name}/${g_subject}.RestingStateStats.${g_project}.${g_session}.${scan}.${current_seconds_since_epoch}.interactive.stdout
		standard_err_file=${working_directory_name}/${g_subject}.RestingStateStats.${g_project}.${g_session}.${scan}.${current_seconds_since_epoch}.interactive.stderr
		...
		standard_out_file=${working_directory_name}/${g_subject}.RestingStateStats.${g_project}.${g_session}.${scan}.${current_seconds_since_epoch}.interactive_PUT.stdout
		standard_err_file=${working_directory_name}/${g_subject}.RestingStateStats.${g_project}.${g_session}.${scan}.${current_seconds_since_epoch}.interactive_PUT.stderr
