...
script_file_to_run=${working_directory_name}/${subject}.PostFix.${project}.${session}.${current_seconds_since_epoch}.XNAT_PBS_job.sh
...
echo "/home/HCPpipeline/pipeline_tools/xnat_pbs_jobs/PostFix/PostFix.XNAT.sh \\" >> ${script_file_to_run}
